 ...
 *
 * <p>Simply returning null  from search methods is ambiguous on the part of the caller, because the caller
 * can then not tell whether  * the tree is empty or not by simply checking for null-ity of the object reference. While, strictly
